    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.aspx" class="logo">
          ...
          <span class="logo-lg">Repo Dosen</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">REPO</php> </span>
                </a>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>SELAMAT DATANG</p>
              <a href="index.php"><i class="fa fa-circle text-success"></i>Repository</a>
            </div>
          </div>
          <!-- search form -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Dashboard
            <small>Repository Dosen IBN Lampung  </small>
          </h1>
          <ol class="breadcrumb">
       ...
       <?php  echo"<div class='row'>
                <div class='col-lg-12'>
                    <div class='panel panel-default'>
                        <div class='panel-heading'>Repository Dosen IBN Lampung 
                        </div>
...
$no=0;
$tebaru=mysqli_query($koneksi," SELECT * FROM repo JOIN pegawai where repo.id_pegawai=pegawai.id_pegawai");
